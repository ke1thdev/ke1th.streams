(() => {
  ...
  function getHomeRows(category = 'all') {
    ...
    return [
      ...
      { key: 'new_ph', title: 'New Filipino Releases', fetchFn: () => TMDB.discoverFilipino('primary_release_date.desc'), fallbackType: catFallback, limit: 14, allowMixed: true, tileStyle: 'landscape' },
